...
<!--Comment-->
<div class="modal fade" id="comment_<?php echo $row['w_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                <h4 class="modal-title" id="myModalLabel" style="color: black; 
                font-weight: bold; text-align: center;">Edit Job Service Details</h4>
                
            </div>
            <div class="modal-body">
            <form action="../actions/comment-order.php" method="post">
                    ...
                    <div class="row form-group" style="display: none;">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="wassigned" value="<?php echo $row['s_id']; ?>" >
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="wcomment"><?php echo $row['w_comment']; ?></textarea>
                        </div>
                    </div>
...
<!-- Edit Modal -->
<div class="modal fade" id="edit_<?php echo $row['w_id']; ?>_edit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
