...
<div class="modal fade" id="delete_<?php echo $row['a_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
                <h3 class="modal-title text-center" id="exampleModalLabel" style="color: black; font-weight: bold;">Delete the Asset?</h3>
...
<div class="modal fade" id="edit_<?php echo $row['a_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="../actions/edit-asset.php" method="post">
                ...
                <div class="row form-group" style="display: none;">
                    ...
                    <div class="modal-header">
                        <h3 class="modal-title text-center" id="exampleModalLabel" style="color: black; font-weight: bold;">Edit Asset Status</h3>
                        <button class="close" type="button" data-dismiss="modal" aria-label="Close"></button>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea class="form-control" name="aremarks" rows="4" required><?php echo $row['a_remarks']; ?></textarea>
                        </div>
                    </div>                
            </div>
            <!-- End of Modal Body -->
